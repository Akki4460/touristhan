...
<html>
<head>
<title>Touristhan | <?php 
echo $_GET['type'];?></title>
...
<!--- privacy ---->
<div class="privacy">
	<div class="container-lg no">
										<?php 
$pagetype=$_GET['type'];
// $pagetype = $pagetype=='privacy'?'terms':'privacy';
// if ($pagetype='privacy') {
// 	$sql = "SELECT type,detail from tblpages where type=privacy or type=term";
// }
